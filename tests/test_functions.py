...
@pytest.mark.parametrize("hole_cards, score", [
...
@pytest.mark.parametrize("string, expected", [
    ...
    ("As Ks Qs Js Ts", [Card(14, 4), Card(13, 4), Card(12, 4), Card(11, 4), Card(10, 4)]),
    ("2h, Qs, 7d, 6c", [Card(2, 3), Card(12, 4), Card(7, 2), Card(6, 1)]),
    ("2h, Qs, 7d, 6c, 5c", [Card(2, 3), Card(12, 4), Card(7, 2), Card(6, 1), Card(5, 1)]),
    ])
